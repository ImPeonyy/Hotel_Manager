    ...
    public class DbInitializer
    {
        public static void Initialize(HotelContext hotelContext)
        {
            ...
            var accounts = new Account[]
            {
                ...
                new Account { username = "user1", password = "123123", name = "Phạm User", phoneNumber = "0346991600", role=0 },
                new Account{username = "user2", password ="123456", name= "Minh User", phoneNumber= "0346991600", role=1 }
            };
            ...
            var menus = new Menu[]
            {
                ...
                new Menu{dishName="Fried chicken with fish saucen", dishDescription="Fried chicken with fish sauce, a savory delight that tantalizes the taste buds.",dishPrice= 50 , dishImage="/img/Menu/images.jpg"}
