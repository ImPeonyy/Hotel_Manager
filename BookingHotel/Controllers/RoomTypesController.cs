...
namespace BookingHotel.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("roomTypeID,roomTypeName,roomLeft")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("roomTypeID,roomTypeName,roomLeft")] RoomType roomType)
        {
